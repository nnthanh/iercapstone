...
namespace IERSystem.BusinessLogic.TableForms
{
    public static partial class CacSoNhanMauAPIImpl
    {
        ...
        //private static CacSoNhanMau queryCacSoNhanMau_Row(YeuCauLayMauInputModel request, IERSystemModelContainer db) {
        ...
        //            TenDiaChiKH = request.TenKhachHang + "/" + request.DiaChiKhachHang,
        //            MaMau = sample.MaMau,
